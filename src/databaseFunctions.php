<?php
	...
	*/
	...
	/**
	*	Funktionen myDBQuery exekverar en SQL fr?a mot en given databas.
	*	Om SQL fr?an misslyckas kastas ett undantag. Om allt fungerar returneras en tabell med efterfr?ad data.
	*
	*	@param resurce $dbConnection Databaskoppling
	*	@param string $strSQL SQL fr?an i klartext
	...
	*/
	...
	/**
	*	Funktionen myDBClose st?ger kopplingen mot given databas i MySQL.
	*	Om st?gningen misslyckas kastas ett undantag.
	*
	*	@param resurce $dbConnection Databaskoppling
	*/
